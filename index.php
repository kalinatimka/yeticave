    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            <?php
                ...
                while ($index < $annCount) {
            ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $announcements[$index]['url']?>" width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?= $announcements[$index]['category']?></span>
                    <h3 class="lot__title"><a class="text-link" href="lot.html"><?= $announcements[$index]['title']?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?= $announcements[$index]['price']?><b class="rub">р</b></span>
                        </div>
